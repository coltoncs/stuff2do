...
export const EventViewer = () => {
  ...
  return event && (
    <div className="fixed rounded border bottom-1/10 left-0 w-screen sm:left-3/10 sm:w-lg bg-gray-800 border-slate-600 p-5 w-lg h-fit shadow-lg shadow-slate-950">
